...
Replace all references to 'socialsandbox3.net' with your own domain name.
...
```bash
curl https://socialsandbox3.net/xrpc/_health
```

WebSockets should also work:

```bash
wsdump "wss://socialsandbox3.net/xrpc/com.atproto.sync.subscribeRepos?cursor=0"
```
